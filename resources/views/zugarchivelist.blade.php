            ...
            <div class="row">
                ...
                <table class="table">
                    ...
                    <tr style="text-align: center;">
                            ...
                            <th scope="col"  class="hide-on-small">Datum</th>
                    ...
                    @foreach ($zugs as $key => $zug)
                        <tr style="text-align: center;">
                            ...
                            <td>{{ $zug->zugnummer }}</td>
                            <td class="hide-on-small">{{ $zug->datum }}</td>
                            <td >{{ $zug->name }}</td>
                            <td class="hide-on-small">{{ $zug->nachname }}</td>
                           
                            <td>{{ $zug->ref }}</td>
                            <td><a href="{{ route('wagonarchivelist', [$zug->id]) }}" style="color: blue;"> archiveliste </a></td>
