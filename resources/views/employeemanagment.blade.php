    ...
    <main id="main">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <br><br>
                <div>
                <a class="btn btn-dark" href="{{route('add-employee')}}">add employee <i class="bi bi-plus-circle"></i></a>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr style="text-align: center;">
                            ...
                            <form action="/deleteemp/{{ $user->id }}" method="POST" id="deleteForm-{{ $user->id  }}">
                                @csrf
                            </form>
                        </tr>
