                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('forget.password.post') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email"  class="form-control" placeholder="Email address" id="email_address"  name="email" required autofocus>
                                            @if ($errors->has('email'))
                                            <span class="text-danger">{{ $errors->first('email') }}</span>
                                            @endif
                                        </div>

                                        <input name="login" id="login" class="btn btn-block login-btn mb-4" type="submit" value=" Send Password Reset Link">
                                    </form>
