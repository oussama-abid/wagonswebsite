    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <form method="post" action="{{ route('logout') }}">
                            @csrf
                            <button style="border: 0;" class="btn-book-a-table" type="submit">logout</button>
                        </form>
                ...
                <table class="table">
                    <thead class="thead-dark">
                        <tr style="text-align: center;">
                            ...
                            <th scope="col" class="hide-on-small">Versandbahnhof</th>
                            <th scope="col" class="hide-on-small">Bestimmungsbahnhof</th>
                    ...
                    <tbody>
                        ...
                        <tr style="text-align: center;">
                            ...
                            <td class="large ">
                                <button type="button" class="btn btn-danger small-on-small" onclick="confirmDelete2('{{ $zug->id  }}');"> <i class="bi bi-trash3"></i> <span class="hide-on-small"> Löschen </span> </button>
                                <a type="button" class="btn btn-warning small-on-small" href="{{route('edit-zug', ['id' => $zug->id])}}"> <i class="bi bi-pen"></i> <span class="hide-on-small">edit</span></a>
                            </td>
